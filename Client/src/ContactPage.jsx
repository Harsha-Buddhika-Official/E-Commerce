    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-700 py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-white text-center mt-4 max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-end">
                <button
                  className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition-colors"
                  type="submit"
                >
                  Send Message
                </button>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-purple-600 font-medium mt-1">support@shopmart.com</p>
              ...
              <div>
                ...
                <p className="text-purple-600 font-medium mt-1">techsupport@shopmart.com</p>
              ...
              <div>
                ...
                <p className="text-purple-600 font-medium mt-1">business@shopmart.com</p>
              </div>
